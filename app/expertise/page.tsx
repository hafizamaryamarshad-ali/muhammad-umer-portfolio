...
export default function ExpertisePage() {
  return <SiteShell activePath="/expertise">
    <PageHeader code="CAPABILITIES / 02" kicker="Automation expertise" title="Engineering the work between systems." intro="A focused technical practice spanning Python, AI, APIs, workflow automation, and the applications teams use to operate them." />
    <Reveal className="section systems-map"><div className="map-copy"><p className="section-kicker">System architecture</p><h2>One workflow. Multiple technical layers.</h2><p>The value sits in how each layer is connected, validated, and made dependable.</p></div><div className="map-surface"><span>REFERENCE FLOW / 01</span><Flow steps={['Business trigger', 'Python service', 'AI / API', 'Validation', 'Action']} animated /><div className="map-notes"><span>01 · Controlled input</span><span>02 · Explicit logic</span><span>03 · Observable output</span></div></div></Reveal>
